...
public class DistanceMeter : MonoBehaviour
{
		...
		{	
				...
				distanceDiffMin = GameObject.FindObjectOfType<SceneManagerStory> ().distanceDiffMin;
		...
		{
				maxBounds = 50f + distanceDiffMin;
				currentDistanceDiff = GameObject.FindObjectOfType<SceneManagerStory> ().currentDistanceDiff;
				distanceDiffMin = GameObject.FindObjectOfType<SceneManagerStory> ().distanceDiffMin;
