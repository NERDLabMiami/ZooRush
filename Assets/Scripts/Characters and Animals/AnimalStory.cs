...
{	
		...
		void Start ()
		{
				...
				GameObject animalIconSprite = GameObject.Find ("Animal Icon");
				if (animalIconSprite != null) {
						animalIconSprite.GetComponent<SpriteRenderer> ().sprite = animalIcon; //Changes the icon in the distance meter
				}
		}
